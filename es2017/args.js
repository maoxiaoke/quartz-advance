...
export const CreateArgv = _object_spread_props(_object_spread({}, CommonArgv), {
    source: {
        string: true,
        alias: [
            "s"
...
export const SyncArgv = _object_spread_props(_object_spread({}, CommonArgv), {
    commit: {
        boolean: true,
        default: true,
...
export const BuildArgv = _object_spread_props(_object_spread({}, CommonArgv), {
    output: {
        string: true,
        alias: [
            "o"
